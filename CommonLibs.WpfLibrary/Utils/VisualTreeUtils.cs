...
namespace CommonLibs.WpfLibrary.Utils
{
    public static class VisualTreeUtils
    {
        ...
        public static IList<T> FindDirectChildren<T>(DependencyObject pParent)
            where T : DependencyObject
        {
            if (pParent == null)
                return null;
            ...
            var childrenCount = VisualTreeHelper.GetChildrenCount(pParent);
            for (var i = 0; i < childrenCount; i++)
            {
                var child = VisualTreeHelper.GetChild(pParent, i);
                T childType = child as T;
                if (childType != null)
